...
class AppointmentAdmin(admin.ModelAdmin):
    list_display = ('customer_name', 'customer_phone', 'doctor', 'appointment_date', 'appointment_time', 
    ...
    fieldsets = (
        ('Thông tin lịch hẹn', {
            'fields': ('customer_name', 'customer_phone', 'doctor', 'branch', 'services', 'services_with_quantity', 'appointment_date', 
...
class AppointmentHistoryAdmin(admin.ModelAdmin):
    ...
    search_fields = ('appointment__customer_name', 'appointment__customer_phone',
